...
return [
     ...
     */
    'max_file_size' => 1024 * 1024 * 5, // 5MB — keep the shared Netsons storage lean
    ...
    /*
     * By default all conversions will be performed on a queue. The shared
     * Netsons host runs no queue worker, so conversions are generated
     * synchronously during the upload request instead.
     */
