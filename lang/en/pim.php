...
return [
    ...
    'action' => [
        ...
        'bulk_set_stock_and_dimensions' => 'Set stock and dimensions',
        'set_price' => 'Set price',
    ...
    'notification' => [
        ...
        'status_bulk_updated' => 'Status set to ":status" for :count product(s)',
        'bulk_dimensions_nothing_to_set' => 'Fill in at least one field to set',
        'stock_dimensions_bulk_updated' => ':count product updated|:count products updated',
        'stock_dimensions_bulk_excluded' => ':count excluded (variable product, has no such fields)|:count excluded (variable products, have no such fields)',
    ...
    'import' => [
        ...
        'error' => [
            ...
            'name_unmapped_with_parents' => 'You mapped the "Parent SKU" column: also map a column to the Name field — it is needed to create the parent products.',
        ...
        'issue' => [
            ...
            'parent_not_found' => 'row :line: parent with SKU ":sku" not found, variant not imported',
            'parent_is_variant' => 'row :line: the SKU ":sku" given as parent is already a variant of another product; nested variants are not supported',
            'parent_exists_update_off' => 'row :line: ":sku" already exists as a simple product and "update existing products" is off: it was not converted to a variable product',
            'parent_converted' => 'row :line: ":sku" existed as a simple product and was converted to a variable product; its price and stock were removed (they now live on the variants)',
            'variant_parent_blocked' => 'row :line: the parent product ":sku" was not imported, variant skipped',
            'variant_sku_conflict' => 'row :line: the SKU ":sku" already belongs to a product that is not a variant, row skipped',
            'variant_name_missing' => 'row :line: variant ":sku" imported without a name (neither on the row nor on the parent product)',
