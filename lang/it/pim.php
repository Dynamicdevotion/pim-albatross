...
return [
    ...
    'import' => [
        ...
        'error' => [
            ...
            'name_unmapped_with_parents' => 'Hai mappato la colonna «Codice Padre»: assegna anche una colonna al campo Nome, serve per creare i prodotti padre.',
        ...
        'issue' => [
            ...
            'parent_not_found' => 'riga :line: padre con SKU «:sku» non trovato, variante non importata',
            'parent_is_variant' => 'riga :line: lo SKU «:sku» indicato come padre è già una variante di un altro prodotto; le varianti annidate non sono supportate',
            'parent_exists_update_off' => 'riga :line: «:sku» esiste già come prodotto semplice e l\'aggiornamento dei prodotti esistenti è disattivato: non è stato convertito in prodotto a varianti',
            'parent_converted' => 'riga :line: «:sku» esisteva come prodotto semplice ed è stato convertito in prodotto a varianti; prezzo e giacenza del prodotto sono stati rimossi (ora vivono sulle varianti)',
            'variant_parent_blocked' => 'riga :line: il prodotto padre «:sku» non è stato importato, variante saltata',
            'variant_sku_conflict' => 'riga :line: lo SKU «:sku» appartiene già a un prodotto che non è una variante, riga saltata',
            'variant_name_missing' => 'riga :line: variante «:sku» importata senza nome (né sulla riga né sul prodotto padre)',
